        ...
        function result = plotProbabilityParameters(obj, edge_test_options, edge_test_result, test_method, plot_statistic,...
            ...
            function brainFigureButtonCallback(network1, network2)
                ...
                brain_plot = nla.gfx.brain.BrainPlot(edge_test_result, edge_test_options, obj.updated_test_options, ...
                                                    network1, network2, edge_test_options.net_atlas, ...
                                                    'force_ball_stick_plot',obj.force_ball_stick_brain_plot,...
                                                    'test_name',obj.network_test_results.test_name,...
                                                    'ROI_radius_min_max',[2 4]);
