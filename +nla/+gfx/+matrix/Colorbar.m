classdef Colorbar < matlab.graphics.chartcontainer.mixin.Colorbar
    ...
    methods
        ...
        function createColorBar(obj, axes, matrix_object)
            if matrix_object.discrete_colorbar
                ...
                colormap(axes, display_color_map);
            else
                number_of_ticks = min(size(matrix_object.color_map, 1) - 1, 10);
                colormap(axes, matrix_object.color_map);
            end

            obj = colorbar(axes);
            obj.createColorBarTicks(number_of_ticks)
            obj.setPosition(matrix_object, axes)
        ...
        function setPosition(obj, matrix_object, axes)
