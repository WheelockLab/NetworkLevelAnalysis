classdef Heteroskedastic_FAST < nla.helpers.stdError.AbstractSwEStdErrStrategy
    ...
    methods
        ...
        function stdErr = calculate(obj, sweStdErrInput)
            ...
            betaCovarianceFlat = correctionFactor * (invDesMtxSelfMultPreCompute * (residual.^2));
