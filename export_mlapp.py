...
for filename in [('./NLA_GUI.mlapp', './NLA_GUI_exported.m'), ('./NLAResult.mlapp', './NLAResult_exported.m'), ('./+net/+result/+plot/NetworkTestResultPlotApp.mlapp', './+net/+result/+plot/NetworkTestResultApp_exported.m')]:
