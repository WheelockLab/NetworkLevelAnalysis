...
for filename in [('./NLA_GUI.mlapp', './NLA_GUI_exported.m'), ('./NLAResult.mlapp', './NLAResult_exported.m'), ('./+nla/+net/+result/+plot/NetworkTestResultPlotApp.mlapp', './+nla/+net/+result/+plot/NetworkTestResultApp_exported.m')]:
